    ...
    >
      <div className="flex items-end justify-between gap-8">
        ...
        <button
          ...
          className="h-11 rounded-xl border border-[var(--border)] bg-[var(--bg-surface)] px-6 text-sm font-bold text-slate-500 shadow-sm transition hover:bg-[var(--bg-surface-elevated)] hover:text-slate-800 active:scale-[0.98] disabled:cursor-default disabled:opacity-50"
        >
          Mark all as read
        </button>
      </div>

      <div className="inline-flex items-center rounded-2xl border border-[var(--border)] bg-[var(--bg-surface)] p-1.5 shadow-sm backdrop-blur-md">
      ...
      <section className="rounded-[28px] border border-[var(--border)] bg-[var(--bg-card)] p-6 shadow-[var(--shadow-card)] backdrop-blur-md">
      ...
      <div className="space-y-3">
        {notifications.map((notification) => (
          <div
            ...
            className={cn(
              "group flex w-full items-start gap-4 rounded-2xl border border-[var(--border)] bg-[var(--bg-card)] p-4 transition-all duration-200 hover:-translate-y-1 hover:scale-[1.02] hover:shadow-lg hover:border-indigo-200/80 cursor-pointer",
