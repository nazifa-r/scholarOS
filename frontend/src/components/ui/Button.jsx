...
const variants = {
  ...
  dark: "inline-flex items-center justify-center rounded-full border border-white/15 bg-slate-950 px-5 py-3 text-sm font-semibold text-white shadow-[0_20px_50px_rgba(15,23,42,0.25)] hover:-translate-y-0.5 hover:bg-slate-900",
};
